...
class Recommendations(DateModel):
  ...
  recommendation_type = models.CharField(max_length=20, choices=[("wwe", "recommendation_type frequently_bought_together similar_products based_on_history trending")])
