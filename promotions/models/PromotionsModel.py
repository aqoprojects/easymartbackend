...
class Promotions(DateModel):
  promotion_id = models.UUIDField(default=uuid.uuid4, primary_key=True, unique=True, editable=False)
  name = models.CharField(max_length=200)
  description = models.TextField(max_length=500)
  DISCOUNT = models.TextChoices("discount_type", "percentage fixed")
  discount_type = models.CharField(max_length=20, choices=DISCOUNT.choices)
