...
class SearchHistory(models.Model, DateModel):
  search_history_id = models.UUIDField(default=uuid.uuid4, primary_key=True, unique=True, editable=False)
  ...
  def str(self):
    return "This is SearchHistory data"
