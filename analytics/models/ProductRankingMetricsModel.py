...
class ProductRankingMetrics(DateModel):
  ...
  METRIC = models.TextChoices("metric_type", "sales views add_to_cart wishlist_adds search_click")
  metric_type = models.CharField(max_length=20, choices=METRIC.choices)
