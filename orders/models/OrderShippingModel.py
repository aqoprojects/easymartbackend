...
from customer.models.ShippingMethodsModel import ShippingMethods
class OrderShipping(models.Model, DateModel):
  ...
  shipping_method_id = models.ForeignKey(ShippingMethods, on_delete=models.CASCADE, related_name="%(app_label)s_%(class)s_shipping_method_id")
